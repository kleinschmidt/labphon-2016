...
```{r supunsup-belief-updating-qualitative, fig.height=2, fig.width=8, out.width='\\textwidth', fig.cap="After exposure, listeners’ /b/-/p/ classifications (thin lines) reflected a compromise between the boundary for a typical talker (dashed black) and the experimental talker (dashed colored).  Moreover, more extreme shifts led to less complete adaptation (lower percentage of boundary shift from typical to experimental; not shown for 0ms shift because experimental and typical talkers are too similar to reliably measure percentage)."}
